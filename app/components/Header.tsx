...
import EbookModal from '@/app/components/EbookModal'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 py-3 flex items-center justify-between">
          ...
          <div className="hidden lg:block">
            <button
              ...
              className="bg-primary hover:bg-primary-dark text-secondary font-extrabold text-xs px-5 py-2.5 rounded-md transition-all inline-block uppercase tracking-wider cursor-pointer active:scale-95"
            >
              GET FREE E-BOOK
            </button>
          </div>
