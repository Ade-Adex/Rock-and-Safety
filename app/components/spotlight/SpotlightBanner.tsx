...
export default function SpotlightBanner({
  ...
  return (
    <section className="bg-[#0F3A2E] text-white rounded-2xl p-8 sm:p-12 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl border border-accent-gold/20">
      ...
      <button
        type="button"
        className="bg-accent-gold hover:bg-yellow-500 text-black font-extrabold text-sm px-6 py-3.5 rounded-xl transition-all shrink-0 active:scale-95 shadow-md cursor-pointer"
      >
        {ctaText}
      </button>
    </section>
