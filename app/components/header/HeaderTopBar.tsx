...
export default function HeaderTopBar() {
  return (
    <div className="bg-card-bg text-muted text-xs py-2 px-4 sm:px-8 border-b border-card-border">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-2">
        {/* Contact Details */}
        <div className="flex items-center space-x-4 sm:space-x-6 text-[11px] sm:text-xs">
          <a
            href="tel:+2348152245314"
            className="whitespace-nowrap flex items-center gap-1.5 hover:text-primary transition-colors"
          >
            <span>📞</span> +234 815 224 5314
          </a>
          <a
            href="mailto:info@rockandsafety.com"
            className="truncate max-w-50 min-[400px]:max-w-none flex items-center gap-1.5 hover:text-primary transition-colors"
          >
