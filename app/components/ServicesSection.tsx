...
import SectionHeader from '@/app/components/ui/SectionHeader'
import { services } from '@/app/data/services'
import { PortfolioItem } from '@/app/data/portfolioData'

// Helper map to match service titles to Portfolio Categories
const serviceToCategoryMap: Record<string, PortfolioItem['category'] | 'All'> =
  {
